...
| [features/customer-accounts-follows.md](features/customer-accounts-follows.md) | Customer web accounts (sign-up, role-aware login) and the web follow/unfollow/mute MVP + Following page; engagement logging; what's deferred to push. |
