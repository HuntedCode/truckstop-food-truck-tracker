...
> The visual and interaction foundations for Chuckwagon. Last updated: 2026-06-04. Scope: foundations (principles, tokens, core MVP components). Expanded per-screen as we build.
