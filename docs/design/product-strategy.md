...
> Vision and business-model decisions for Chuckwagon. Last updated: 2026-06-04.
...
Chuckwagon's core loop is **location + time**: "which trucks are near me, on which days and times." Every feature and data-model decision is tested against whether it serves that loop. When clarity ("where is my truck right now") conflicts with anything else, the spine wins.
